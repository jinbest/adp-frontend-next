...
export class StoresDetails {
  ...
  changeCommonCnts = (commonCnts: any) => {
    this.commonCnts = {...commonCnts, badgeImg: data["commonCnts"]["badgeImg"], locationsData: data["commonCnts"]["locationsData"], repairPhoneImg: data["commonCnts"]["repairPhoneImg"], repairWidget: data["commonCnts"]["repairWidget"]}
    this.save()
  }
