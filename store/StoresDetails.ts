...
export class StoresDetails {
  ...
  changeCommonCnts = (commonCnts: any) => {
    this.commonCnts = {...commonCnts, badgeImg: data["commonCnts"]["badgeImg"], locationsData: data["commonCnts"]["locationsData"], repairPhoneImg: data["commonCnts"]["repairPhoneImg"]}
    this.save()
  }
